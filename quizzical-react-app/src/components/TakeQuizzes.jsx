                ...
                <div className="card">
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      Think you know your tacos from your taquitos? Put your
                      food knowledge to the test with the Quizzical Food quiz on
                      international dishes and cuisines.
                    </p>
                    <br></br>
                    <button onClick={this.foodQuiz} className="btn btn-primary">
                      Take Quiz
                    </button>
                  </div>
                </div>
              ...
              <div className="Cards">
                <div className="card">
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      Think you know geography? We'll see about that. Settle in
                      with our quiz and take a trip around the world, all
                      without leaving the house.Test yourself with his
                      extra-tricky geo-quiz!
                    </p>
                    <button
                      onClick={this.geographyQuiz}
                ...
                <div className="card">
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      ...
                      thousands of facts about each and every one of them. Test
                      your knowledge about animals by taking this quiz.{" "}
                    </p>
                    <button
                      onClick={this.animalQuiz}
                      className="btn btn-primary"
                    >
                      Take Quiz
                    </button>
